...
/* Hashtable::Lookup
 * -----------------
 * Returns the value latest stored under key or NULL
...
template <class Value>
Hashtable<Value>* Hashtable<Value>::MakeCopy() {
    Hashtable<Value>* n = new Hashtable<Value>();
    n->mmap = this->mmap;
    return n; 
}
